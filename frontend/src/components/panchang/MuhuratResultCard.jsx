...
=======
      ...
      <InsightRow label={t("festival:muhurat.tithi")} value={muhurat.auspiciousPeriod.tithi} color="#ffd700" />
      <InsightRow label={t("festival:muhurat.nakshatra")} value={muhurat.auspiciousPeriod.nakshatra} color="#9dc9ff" />
      <InsightRow label={t("festival:muhurat.auspiciousWindow")} value={`${muhurat.auspiciousPeriod.window.start} – ${muhurat.auspiciousPeriod.window.end}`} color="#7effb2" />

      <div style={{ marginTop: 14 }}>
        <div style={{ fontSize: 12.5, color: "#ff8f7e", fontWeight: 600, marginBottom: 8 }}>⚠ {t("festival:muhurat.cautionPeriod")}</div>
