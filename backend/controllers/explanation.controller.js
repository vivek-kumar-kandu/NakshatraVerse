...
export const postReportSummary = asyncHandler(async (req, res) => {
  ...
  try {
    const result = await getReportSummary({ chart, report, history, language: req.language });
    res.json(result);
  } catch (err) {
...
export const postConfidenceExplanation = asyncHandler(async (req, res) => {
  ...
  try {
    const result = await getConfidenceExplanation({ chart, report, category, history, language: req.language });
    res.json(result);
  } catch (err) {
...
export const postPredictionEvidence = asyncHandler(async (req, res) => {
  ...
  const { chart, report, category, history } = req.body;
  try {
    const result = await getPredictionEvidence({ chart, report, category, history, language: req.language });
    res.json(result);
  } catch (err) {
...
export const postRemedyExplanation = asyncHandler(async (req, res) => {
  ...
  try {
    const result = await getRemedyExplanation({ chart, report, remedyType, history, language: req.language });
    res.json(result);
  } catch (err) {
